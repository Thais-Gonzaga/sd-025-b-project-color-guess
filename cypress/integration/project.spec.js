...
describe('3 - Adicione à página opções de cores para serem adivinhadas', () => {
  beforeEach(() => {
    cy.visit('./index.html');
  });
...
describe('4 - Adicione cores aos círculos, que devem ser geradas dinamicamente', () => {
  beforeEach(() => {
    cy.visit('./index.html');
  });
...
describe('5 - Ao clicar em um círculo colorido, deve ser mostrado um texto indicando se está correto', () => {
  beforeEach(() => {
    cy.visit('./index.html');
  });
